...
namespace Lab_13_OOP
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/car.dat", FileMode.OpenOrCreate))
            {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/car.json", FileMode.OpenOrCreate))
            {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/car.xml", FileMode.OpenOrCreate))
            {
                formatter.Serialize(fs, mazda);
            ...
            using (FileStream file = new FileStream(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/cars.xml", FileMode.OpenOrCreate))
            {
                xmlFormatter2.Serialize(file, cars);
            }
            using (FileStream file = new FileStream(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/cars.xml", FileMode.Open))
            {
            ...
            xml.Load(@"C:\Users\User\Desktop\универ\БГТУ\2 Курс\ООП\2 курс\All Lab\LAB_14/cars.xml");
